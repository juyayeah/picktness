 ...
 * @Configuration
 * 
 * @PropertySource("classpath:email.properties") public class EmailConfig {
 * 
 ...
 * 
 * @Value("${AdminMail.id}") private String id;
 * 
 * @Value("${AdminMail.password}") private String password;
 * 
 * @Bean public JavaMailSender javaMailService() { JavaMailSenderImpl
 * javaMailSender = new JavaMailSenderImpl();
 * 
 * javaMailSender.setHost("smtp.naver.com");
 * javaMailSender.setUsername("picktness@naver.com");
 * javaMailSender.setPassword("vlrxmsltm123"); //비밀번호 픽트니스123
 ...
 * 
 * private Properties getMailProperties() { Properties pt = new Properties();
 * pt.put("mail.smtp.socketFactory.port", socketPort); pt.put("mail.smtp.auth",
 * auth); pt.put("mail.smtp.starttls.enable", starttls);
