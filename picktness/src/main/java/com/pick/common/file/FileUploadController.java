...
public class FileUploadController {
	...
	private List<String> fileProcess(MultipartHttpServletRequest multipartRequest) throws Exception{
		...
		while(fileNames.hasNext()){
			...
			File file = new File(TODAYMILL_IMAGE_REPO +"\\"+ fileName);
			...
			if(mFile.getSize()!=0){
				...
				mFile.transferTo(new File(TODAYMILL_IMAGE_REPO +"\\"+ originalFileName)); //임시로 저장된 multipartFile을 실제 파일로 전송
			}
		}
