...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=abeab8cce28d6c80ad107bfe4e602d58&libraries=services,clusterer,drawing"></script>
<script>
      $(function () {
...
<body>
				...
				<div class="main_box">
					...
					<c:forEach items="${trainerList }" var="trainer">
						<div class="main_item"
							...
							<span class="title">${trainer.name }</span> <span
								class="trainer_work">${trainer.b_name }</span> <span
								class="location">${trainer.addrBasic } </span> <span
								class="location"> <fmt:formatNumber pattern="0.0"
									value="${trainer.distance/1000 }" />km
							</span>
							...
							<c:if test="${trainer.review_count ne 0 }">
								<div class="star">
									<img src="${contextPath}/images/main/star.png" /> <span
										class="star">${trainer.review_star }(${trainer.review_count })</span>
								</div>
							</c:if>
						</div>
					</c:forEach>
	...
	<div class="modal_location">
		<div class="modal_head">
			<img class="map-arrow" id="arrow1"
				src="${contextPath}/images/goods/map-arrow.png" />
			<div class="modal_title">지도에서 위치 지정</div>
			<div class="modal_fix">위치지정</div>
		</div>
		<div class="modal_search">
			<input type="text" spellcheck="false" id="input_location"
				maxlength="100" placeholder="동, 역으로 검색해서 지정하기" />
		</div>
		<div id="location_map"></div>
	</div>
	<div class="modal_map">
		<div class="modal_head">
			<img class="map-arrow" id="arrow2"
				src="${contextPath}/images/goods/map-arrow.png" />
