                     ...
                     <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                           ...
                           <img src="${contextPath}/images/member/park1.jpg"
                              class="img-size" />
                           <div class="text">
                        <a href="${contextPath}/images/member/park1.jpg" data-title="사진1" data-lightbox="example-set">전체보기</a>
                        <a style="display:none;" href="${contextPath}/images/member/park2.jpg" data-title="사진2" data-lightbox="example-set"></a>
                        <a style="display:none;" href="${contextPath}/images/member/park3.jpg" data-title="사진3" data-lightbox="example-set"></a>
                        <a style="display:none;" href="${contextPath}/images/member/park4.jpg" data-title="사진3" data-lightbox="example-set"></a>                     
                        </div>
                        </div>
