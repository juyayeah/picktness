...
<body>
<div class="bodybody">
   <form action="${contextPath }/member/modStudent.do" method="post" name="frmStudent" enctype="multipart/form-data">
   <div>
      <table border=0 align="center" width="1100px">
            <tr><!-- 사진칸 -->
               <td class="detail_gym_img" width="40%" height="40%" rowspan="7"><input type="hidden" name="originalFileName"
                  value="${user.imageFileName }" /> 
      ...
      <div class="mySlides fade">
        ...
        <img src="${contextPath}/images/member/park1.jpg" class="img-size"/>
        <div class="text">Picktness</div>
      </div>

      <div class="mySlides fade">
        <div class="numbertext">2 / 4</div>
        <img src="${contextPath}/images/member/park2.jpg" class="img-size">
        <div class="text">Picktness</div>
      </div>

      <div class="mySlides fade">
        <div class="numbertext">3 / 4</div>
        <img src="${contextPath}/images/member/park3.jpg" class="img-size">
        <div class="text">Picktness</div>
      </div>

      <div class="mySlides fade">
        <div class="numbertext">4 / 4</div>
        <img src="${contextPath}/images/member/park4.jpg" class="img-size">
        <div class="text">Picktness</div>
      </div>
 ...
 <!-- 트레이너 정보 -->
					...
					<a style="padding:0 0 0 30px; font-size:13px;" href="https://map.naver.com/v5/entry/place/1213678018?c=15,0,0,0,dh">대전광역시 서구 대덕대로 226 명동플라자 2층 헬스보이짐</a>
					<!-- 고객이 보는 창 --> 
					<input type="hidden" value="${member.num}"	name="num" />
					<!-- 인터페이스 --></td>
				</tr>
				<tr>
				<td align="left" ><span style="padding:0 0 0 30px; font-size:20px;">P.T 이용권</span></td>
				</tr>
				<tr>
				<td  align="left" ><b style="padding:0 0 0 30px; font-size:23px;">10회당 700,000원</b><span style="font-size:11px"> 부터~</span></td>
				</tr>
				<tr>
				...
				<tr>
				<td align="center" ><b style="font-size:23px;">10회 700,000원</b></td>
				</tr>
            <td align="left"  style="padding:0 0 10px 30px;">
            <button class=button_white value="장바구니">장바구니</button>&nbsp;&nbsp;  <button class=button_blue id="nowbuy" onclick="nowbuy()">바로구매</button></td>
            </table>
            </div>
            <hr>
            <div>
      ...
      <!-- 소개 및 정보 시작 -->
            <div class=gymdetail_content style="display:block;" id="gymdetail_content">
            <p>자기소개</p>
            <textarea rows="15" cols="60" name="" disabled/></textarea>
            <p>자격증</p>
            <textarea rows="8" cols="60" name="" disabled/>트레이너 자격사항</textarea>
  
<div>
            <p>소속</p>
            <table>
            <tr>
            <td><img src="${contextPath}/images/member/gym1.png" width="200px" align="right">
</td>
            <td width="10%"></td>
            <td class="addressgym" width="50%">
            <b>헬스보이짐&필라걸 둔산점</b><br>
            대전 서구 대덕대로 226 명동프라자 2층 헬스보이짐<br>
            연락처:0507-1441-8922
            </td>
            </tr>
            </table>
...
<!-- 상품문의 -->
<div class=gymdetail_inquiry style="display:none" id = "gymdetail_inquiry">
<p>상품문의</p>
<textarea rows="15" cols="60" name="" disabled/></textarea>
</div>
</form>
