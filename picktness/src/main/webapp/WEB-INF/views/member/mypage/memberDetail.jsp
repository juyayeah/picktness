  ...
  <script>
    ...
    function handleUpdate() {
      var updatedData = {
        ...
        addrBasic: $("#addr").val(),
        addrDetail: $("#addr_dtl").val(),
        email1: $("#domain-txt1").val(),
        email2: $("#domain-txt2").val(),
        phone1: $("#phone1").val(),
        phone2: $("#phone2").val(),
        phone3: $("#phone3").val(),
      };
      ...
      $.ajax({
        type: "POST",
        url: "member/modifyMember.do",
        data: updatedData,
        dataType: "json",
        success: function (response) {
          alert("회원정보가 수정되었습니다.");
          location.href = "member/mypage/memberDetail.do";
        },
      ...
      <form action="${contextPath}/member/modifyMember.do" method="post">
        <div class="formTool">
          ...
          <div class="form-row">
            ...
            <a
              href="#"
              style="color: #2890f1; font-size: 13px"
              class="disableLink"
              >비밀번호 변경을 원하시면 여기를 클릭해주세요.</a
            ><br />
          </div>
          <script>
          ...
          <div class="form-row">
            ...
            <button class="address-button" type="button" onclick="" hidden>
              인증번호 받기
            </button>
            <span
              class="id_ok"
          ...
          <div class="form-row" hidden>
            ...
            <input
              ...
              class="input-small"
            />
            <button class="address-button" type="button" onclick="verifyCode()">
              확인
            </button>
          </div>
          <div class="form-row2">
        ...
        <div style="text-align: center">
          <a
            href="${contextPath}/member/mypage/delAccount.do"
            style="
