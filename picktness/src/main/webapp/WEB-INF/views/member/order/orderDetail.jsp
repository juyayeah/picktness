  ...
  <body>
    <div class="order_detail">
      ...
      <div class="container">
        ...
        <input type="text" placeholder="2,000원부터 사용가능" />
        <button class="button">전액사용</button>
        <p style="margin-left: 200px">보유포인트 5,000원</p>
        <p style="margin-left: 200px; background-color: #d2e556">
          적립 예정 포인트 204원
        </p>
      </div>
      <hr width="100%" color="#959ea6" style="padding=30px" />
      ...
      <div class="container" style="font: bold italic 2em/1em 돋움체">
        <p>96,000원</p>
        -
      ...
      <h3>결제 방법 선택</h3>
      <div>
        <button type="button" onclick="alert(신용카드 선택 !')">
          신용카드
        </button>
      </div>
      ...
      <div>
        <label class="checkbox-label"
          ><input type="checkbox" />[필수] 개인정보 수집 및 이용 동의</label
        >
      </div>
      <div>
        <label class="checkbox-label"
          ><input type="checkbox" />[필수] 개인정보 제 3자 제공 동의</label
        >
      </div>
      <div>
        <label class="checkbox-label"
          ><input type="checkbox" />[필수] 전자결제대행 이용 동의</label
        >
      </div>
      <div class="order_button">
        <button class="btn2">96,000원 결제하기</button>
      </div>
    </div>
  </body>
</html>
