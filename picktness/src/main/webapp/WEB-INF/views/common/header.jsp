...
<script>
	...
	function fn_myPage() {
		alert("로그인 후 이용해 주세요");
		var uri = "${contextPath }/member/mypage/memberDetail.do";
		$.ajax({
	...
	function fn_cart() {
		alert("로그인 후 이용해 주세요");
		var uri = "${contextPath}/member/cart/cartList.do";
		$.ajax({
			url : "${contextPath}/redirectUri.do",
			method : "post",
			data : {
...
<body>
	<div class="header-inner">
			...
			<c:otherwise>
				<div class="util">
					<ul>
						...
						<li><a href="${contextPath}/member/selectJoin.do">회원가입</a></li>
						<li><a href="${contextPath}/board/noticeList.do">고객센터</a></li>
					</ul>
				</div>
			</c:otherwise>
		...
		<!--/util-->
		<div class="logo_h">
			<img class="logo_h_i" src="${contextPath}/images/logo.png"
				alt="픽트니스 로고 이미지" />
		</div>
		<!--/logo-->
		<div class="header-search">
			<form method="get" action="${contextPath}/goods/searchGoods.do">
				<div class="top_search">
					<input type="search" class="input-search" spellcheck="false"
						placeholder="검색어를 입력하세요" maxlength="100" name="search_content" />
					<button type="submit" class="btn_top_search">
						<img class="btn_top_search_img"
							src="${contextPath}/images/search.png" alt="검색 아이콘" />
					</button>
				</div>
			</form>
		</div>
		...
		<div class="my_menu">
			<c:choose>
				...
				<c:when test="${isLogOn != null && member.id != 'admin'}">
					...
					<button type="button" class="btn_top_cart"
				...
				<c:when test="${isLogOn != null && member.id == 'admin' }">
					<button type="button" class="btn_top_mypage" onclick="location.href='${contextPath}/admin/mypage/adminProdList.do'">
						<img class="btn_top_mypage_img"
							src="${contextPath}/images/mypage.png" alt="마이페이지" />
					</button>
				</c:when>
				<c:otherwise>
					<button type="button" class="btn_top_mypage" onclick="fn_myPage()">
						<img class="btn_top_mypage_img"
							src="${contextPath}/images/mypage.png" alt="마이페이지" />
					</button>
					<button type="button" class="btn_top_cart" onclick="fn_cart()">
						<img class="btn_top_cart_img" src="${contextPath}/images/cart.png"
							alt="카트" />
					</button>
				</c:otherwise>
	...
	<div class="navibar_fixed">
		<div class="navi_inner">
			<div class="menu_all">
				<div class="menu_open">
					<img class="menu_open_img" src="${contextPath}/images/menu.png"
						onclick="openMenu()" />
				</div>
				<div class="menu_close">
					<img class="menu_close_img" src="${contextPath}/images/close.png"
						onclick="closeMenu()" />
				</div>
				<div class="menu_all_list">
					<ul class="menu_list_place">
						<li class="menu_list_title"><a
							href="${contextPath}/goods/placeList.do?cate=all">운동시설</a></li>
					...
					<ul class="menu_list_traniner">
						<li class="menu_list_title"><a
							href="${contextPath}/goods/trainerList.do?cate=all">트레이너</a></li>
						<li class="menu_list_a"><a
					...
					<ul class="menu_list_food">
						<li class="menu_list_title"><a
							href="${contextPath }/goods/shopFoodList.do">식품</a></li>
						<li class="menu_list_a"><a
							href="${contextPath }/goods/shopFoodList.do?cate=tender">닭가슴살</a></li>
						<li class="menu_list_a"><a
							href="${contextPath }/goods/shopFoodList.do?cate=protain">프로틴
								쉐이크</a></li>
					</ul>
					<ul class="menu_list_goods">
						<li class="menu_list_title"><a
							href="${contextPath }/goods/shopGoodsList.do">기구/용품/장비</a></li>
						<li class="menu_list_a"><a
							href="${contextPath }/goods/shopGoodsList.do?cate=masage">스트레칭/마사지</a></li>
						<li class="menu_list_a"><a
							href="${contextPath }/goods/shopGoodsList.do?cate=tape">테이프/아대</a></li>
						<li class="menu_list_a"><a
							href="${contextPath }/goods/shopGoodsList.do?cate=aerobic">근력/유산소
								용품</a></li>
					</ul>
				</div>
			</div>
			<!--/menu_all_list-->
			<div class="menu_sp">
				<span class="menu_sp_title"
					onclick="location.href='${contextPath}/goods/placeList.do?cate=all'">운동시설</span>
				<ul class="menu_sp_dt">
					<li class="menu_list_a"><a
						href="${contextPath}/goods/placeList.do?cate=health">헬스</a></li>
					<li class="menu_list_a"><a
			...
			<!--/menu_sp-->
			<div class="menu_tr">
				<span class="menu_tr_title"
					onClick="location.href='${contextPath}/goods/trainerList.do?cate=all'">트레이너</span>
				<ul class="menu_tr_dt">
					<li class="menu_list_a"><a
						href="${contextPath}/goods/trainerList.do?cate=health">헬스</a></li>
					<li class="menu_list_a"><a
			...
			<!--/menu_tr-->
			<div class="menu_sh">
				<span class="menu_sh_title"
					onclick="location.href='${contextPath}/goods/shoppingMain.do'">쇼핑</span>
			...
			<div class="menu_cm">
				<span class="menu_cm_title"
					onclick="location.href='${contextPath}/board/millBoardList.do'">오늘 식단</span>
			</div>
		</div>
		<!--navi_inner-->
	</div>
