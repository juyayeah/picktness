...
<body>
<form action="${contextPath }/business/mypage/addGymDetail.do">
	<div>
		...
		<table>
			...
			<tr>
				...
				<td class="tdlast">
					<div class="div1">
						<button class="div2">1개월</button>
						<button class="div2">3개월</button>
						<button class="div2">6개월</button>
						<button class="div2">12개월</button>
					</div> <span class="starblue" style="font-size: 11px;">* 픽트니스을 통한
			...
			<tr>
				...
				<td class="blue">정가 <input class="pricebox" type="number"
					name="prod10" placeholder="숫자만 작성해 주세요"> &ndash; 할인 <input
					class="pricebox" type="number" placeholder="숫자만 작성해 주세요" name="prod10sale">
