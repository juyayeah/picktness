...
<body>
<form action="${contextPath }/business/mypage/addGymDetail.do" method="post" name ="frmBusiness" id="addForm" enctype="multipart/form-data">
	...
	<div>
		...
		<table>
			...
			<tr>
				<td colspan="3" align="right"><button type="reset" class="button_white">다시쓰기</button>&nbsp;&nbsp;
				<button class="button_blue" type="button">등록하기</button>
			</tr>
		</table>
	</div>
	</form>
